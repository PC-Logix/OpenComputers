...
object ModOpenComputers extends ModProxy {
  ...
  override def initialize(): Unit = {
    ...
    api.Driver.add(DriverQuadGraphicsCard)
    ...
    api.Driver.add(DriverComputronicsBeepCard)
    api.Driver.add(DriverComputronicsNoiseCard)
    api.Driver.add(DriverComputronicsSoundCard)
    api.Driver.add(DriverComputronicsCameraUpgrade)
    api.Driver.add(DriverComputronicsChatUpgrade)
    api.Driver.add(DriverComputronicsRadarUpgrade)
    api.Driver.add(DriverComputronicsParticleCard)
    api.Driver.add(DriverComputronicsSpoofingCard)
    api.Driver.add(DriverComputronicsSelfDestructingCard)
    api.Driver.add(DriverComputronicsColorfulUpgrade)
    api.Driver.add(DriverComputronicsSpeechUpgrade)
    api.Driver.add(DriverComputronicsServerSelfDestructor)
    api.Driver.add(DriverComputronicsLightBoard)
    api.Driver.add(DriverComputronicsRackCapacitor)
    api.Driver.add(DriverComputronicsSwitchBoard)
    api.Driver.add(DriverComputronicsMagicalMemory)
    ...
    api.Driver.add(DriverQuadGraphicsCard.Provider)
    ...
    api.Driver.add(DriverComputronicsBeepCard.Provider)
    api.Driver.add(DriverComputronicsNoiseCard.Provider)
    api.Driver.add(DriverComputronicsSoundCard.Provider)
    api.Driver.add(DriverComputronicsCameraUpgrade.Provider)
    api.Driver.add(DriverComputronicsChatUpgrade.Provider)
    api.Driver.add(DriverComputronicsRadarUpgrade.Provider)
    api.Driver.add(DriverComputronicsParticleCard.Provider)
    api.Driver.add(DriverComputronicsSpoofingCard.Provider)
    api.Driver.add(DriverComputronicsSelfDestructingCard.Provider)
    api.Driver.add(DriverComputronicsColorfulUpgrade.Provider)
    api.Driver.add(DriverComputronicsSpeechUpgrade.Provider)
    api.Driver.add(DriverComputronicsServerSelfDestructor.Provider)
    api.Driver.add(DriverComputronicsLightBoard.Provider)
    api.Driver.add(DriverComputronicsRackCapacitor.Provider)
    api.Driver.add(DriverComputronicsSwitchBoard.Provider)
    api.Driver.add(DriverComputronicsMagicalMemory.Provider)
